...
; Deep Freeze Fatality Part 1
[Command]
name = "deepfreezepart1"
command = ~F, F, D, c
time = 45

; Deep Freeze Fatality Part 2
[Command]
name = "deepfreezepart2"
command = ~D, DF, F, c
time = 45
...
;[State -1, Finish Him!]
;type = Changestate
;trigger1 = Ctrl = 1 ;It must have the control.
;trigger1 = P2Life = 1 ;Life of P2 must be equal the 1.
;trigger1 = NumHelper(19100) = 0 ;It cannot have another Helper as this in the screen.
...
type = Changestate
value = 19150
;triggerall = Enemy, AnimExist(27000) || Enemy, AnimExist(27001)
...
triggerall = p2stateno = 7022
triggerall = RoundNo != 1 || Enemy, TeamMode = turns
triggerall = command = "harpoonripper"
triggerall = P2Dist X <= 70
triggerall = P2Dist X > 45
triggerall = AILevel = 0
trigger1 = Ctrl
...
triggerall = RoundNo != 1 || Enemy, TeamMode = turns
triggerall = AILevel = 0
trigger1 = command = "laserfinisher"
trigger1 = Ctrl
trigger1 = StateType != A
...
triggerall = RoundNo != 1 || Enemy, TeamMode = turns
triggerall = AILevel = 0
trigger1 = command = "cyberkilla"
trigger1 = Ctrl
trigger1 = StateType != A
trigger1 = P2Dist X >= 140

;============================================
;Ice Breath Fatality Part 1

[State -1, Deep Freeze Fatality Part 1]
type = Changestate
value = 19110
triggerall = RoundState = 2
triggerall = P2Life <= 1
...
triggerall = RoundNo != 1 || Enemy, TeamMode = turns
triggerall = AILevel = 0
trigger1 = command = "deepfreezepart1"
trigger1 = Ctrl
trigger1 = StateType != A
...
;============================================
;Ice Breath Fatality Part 2

[State -1, Deep Freeze Fatality Part 2]
type = Changestate
value = 19111
triggerall = RoundState = 2
triggerall = P2Life <= 1
...
triggerall = RoundNo != 1 || Enemy, TeamMode = turns
triggerall = AILevel = 0
trigger1 = command = "deepfreezepart2"
trigger1 = Ctrl
trigger1 = StateType != A
trigger1 = P2Dist X <= 45

;============================================
;Ice Breath Fatality Part 2.1

[State -1, Deep Freeze Fatality Part 2.1]
type = Changestate
value = 19112
triggerall = RoundState = 2
triggerall = P2Life <= 1
...
triggerall = P2Life <= 1
triggerall = NumHelper(7021) = 1
triggerall = p2stateno = 51000 || p2stateno = 7022
triggerall = RoundNo != 1 || Enemy, TeamMode = turns
triggerall = AILevel = 0
trigger1 = command = "icebomb"
trigger1 = Ctrl
trigger1 = StateType != A
trigger1 = P2Dist X >= 140
...
triggerall = RoundNo != 1 || Enemy, TeamMode = turns
triggerall = AILevel = 0
trigger1 = command = "electrocution"
trigger1 = Ctrl
trigger1 = StateType != A
trigger1 = P2Dist X <= 45
...
[State -1, Stage Fatality - Default]
type = Changestate
value = 19190
triggerall = RoundState = 2
triggerall = Var(22) != 5008
triggerall = Var(22) != 5016
triggerall = P2Life <= 1
triggerall = NumHelper(7021) = 1
triggerall = p2stateno = 7022
triggerall = RoundNo != 1 || Enemy, TeamMode = turns
triggerall = AILevel = 0
trigger1 = command = "spikedceiling"
trigger1 = Ctrl
trigger1 = StateType != A
trigger1 = P2Dist X <= 45

[State -1, Stage Fatality - Deadpool]
type = Changestate
value = 19191
triggerall = RoundState = 2
triggerall = Var(22) = 5008
...
[State -1, Team Fatality 1: Freeze and Destroy]
type = Changestate
value = 9000
triggerall = RoundState = 2
triggerall = P2Life <= 1
...
[State -1, Team Fatality 2: Cut and Freeze]
type = Changestate
value = 9006
triggerall = Enemy, AnimExist(9108109)
triggerall = Enemy, AnimExist(9108091)
triggerall = Enemy, AnimExist(9108092)
triggerall = Enemy, AnimExist(9108093)
triggerall = RoundState = 2
triggerall = P2Life <= 1
triggerall = NumHelper(7021) = 1
triggerall = p2stateno = 7023
...
trigger1 = command = "harpooncut"
trigger1 = (ID = 56 && TeamSide = 1) || (ID = 58 && TeamSide = 2)
trigger1 = P2Dist X <= 45
trigger2 = command = "iceslam"
trigger2 = (ID = 57 && TeamSide = 1) || (ID = 59 && TeamSide = 2)
trigger2 = P2Dist X = [100,120]
...
type = ChangeState
value = 3975
triggerall = (command="lightningbeam" && power>=2000)
triggerall = AILevel = 0
triggerall = NumHelper(14001) != 1
trigger1 = ctrl = 1
trigger1 = statetype = S
...
;Arctic Blade
[State -1, Arctic Blade]
type = ChangeState
value = 12002
triggerall= Command = "arcticblade"
...
;Apocalyptic Blossom
[State -1, Apocalyptic Blossom]
type = ChangeState
value = 17000
triggerall= Command = "apocoblossom"
triggerall = Power >= 3000
triggerall = AILevel = 0
triggerall = NumHelper(14001) != 1
trigger1 = StateType != A
...
triggerall = enemy, StateNo = 7022
triggerall = RoundNo != 1 || Enemy, TeamMode = turns
triggerall = Random <= 385
;triggerall = var(58) >= 1
trigger1 = StateType != A && ctrl = 1
trigger1 = (p2statetype = S) || (p2statetype = C)
trigger1 = P2Dist X <= 45

[State -3, AI - Cyber-Doom]
type = Changestate
value = 19173
triggerall = RoundState = 2
triggerall = AILevel > 0 && RoundState = 2
...
triggerall = enemy, StateNo = 7022
triggerall = RoundNo != 1 || Enemy, TeamMode = turns
triggerall = Random <= 616
;triggerall = var(58) >= 1
trigger1 = StateType != A && ctrl = 1
trigger1 = (p2statetype = S) || (p2statetype = C)
trigger1 = P2Dist X <= 45

[State -3, AI - Stage Fatality 3]
type = Changestate
value = 19192
triggerall = RoundState = 2
triggerall = var(22) = 5016
...
triggerall = enemy, StateNo = 7022
triggerall = RoundNo != 1 || Enemy, TeamMode = turns
triggerall = Random <= 693
;triggerall = var(58) >= 1
trigger1 = StateType != A && ctrl = 1
trigger1 = (p2statetype = S) || (p2statetype = C)
trigger1 = P2Dist X <= 45

[State -3, AI - Stage Fatality 2]
type = Changestate
value = 19191
triggerall = RoundState = 2
triggerall = var(22) = 5008
...
triggerall = NumHelper(7021) = 1
triggerall = NumHelper(7010) != 1
triggerall = enemy, StateNo = 7022 || enemy, StateNo = 51000
triggerall = Random <= 770
triggerall = RoundNo != 1 || Enemy, TeamMode = turns
;triggerall = var(58) >= 1
trigger1 = StateType != A && ctrl = 1
trigger1 = (p2statetype = S) || (p2statetype = C)
...
[State -3, AI - Deep Freeze Fatality Part 1]
type = Changestate
value = 19110
triggerall = RoundState = 2
triggerall = AILevel > 0 && RoundState = 2
...
[State -3, AI - Deep Freeze Fatality Part 2]
type = Changestate
value = 19111
triggerall = RoundState = 2
triggerall = AILevel > 0 && RoundState = 2
...
[State -3, AI - Deep Freeze Fatality Part 2.1]
type = Changestate
value = 19112
triggerall = RoundState = 2
triggerall = AILevel > 0 && RoundState = 2
...
[State -3, AI - Team Fatality 1: Freeze and Destroy]
type = Changestate
value = 9000
triggerall = RoundState = 2
triggerall = AILevel > 0 && RoundState = 2
...
[State -3, AI - Team Fatality 2: Cut and Freeze]
type = Changestate
value = 9006
triggerall = partner, name = "DGBlossom"
triggerall = Enemy, AnimExist(9108109)
triggerall = Enemy, AnimExist(9108091)
triggerall = Enemy, AnimExist(9108092)
triggerall = Enemy, AnimExist(9108093)
...
trigger1 = random <= 32
trigger1 = ctrl = 1
trigger1 = p2dist x >= 70 && p2dist y > -40
